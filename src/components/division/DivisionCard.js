...
import "../../styles/DivisionCard.css"; // ✅ CSS-Import
import "../../styles/Button.css"; // ✅ Zentrale Button-Styles importieren
      ...
      <div className="card-header">
        ...
        {!isEditing && (
          <div className="card-actions">
            <button 
              className="btn btn-secondary btn-edit" // ✅ KORRIGIERT: Zentrale Button-Klassen
              onClick={handleEdit}
              disabled={loading}
            >
              ✏️ Bearbeiten
            ...
            <button 
              className="btn btn-danger btn-delete" // ✅ KORRIGIERT: Zentrale Button-Klassen
      ...
      <div className="card-content">
        {isEditing ? (
          <div className="edit-form">
            ...
            <div className="form-group">
              ...
              >
                ...
                {/* ✅ KORRIGIERT: Dropdown-Optionen basierend auf echten Daten */}
            ...
            <div className="form-group">
              ...
              >
                ...
                {/* ✅ KORRIGIERT: Gender-Werte wie in echten Daten */}
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="text" 
                  name="Minimun_Weight" // ✅ KORRIGIERT: DB-Spaltenname (mit Tippfehler)
            ...
            <div className="form-actions">
              <button 
                className="btn btn-primary btn-save" // ✅ KORRIGIERT: Zentrale Button-Klassen
                onClick={handleSave}
                disabled={loading}
              >
                💾 Speichern
              ...
              <button 
                className="btn btn-secondary btn-cancel" // ✅ KORRIGIERT: Zentrale Button-Klassen
          ...
          <div className="view-content">
            ...
            {/* ✅ KORRIGIERT: Gewichts-Anzeige mit korrektem DB-Feld */}
